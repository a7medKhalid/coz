...
const SideBar = ({ allowedDashboardPages, setActivePage, activePage }) => {
    return (
        <div
            className="fixed top-0 right-0 h-screen w-24 pt-3 flex flex-col
...
const SideBarIcon = ({ icon, text = "tooltip 💡", isActive }) => (
   ...
   hover:bg-primary  
    ...
    >
        {icon}
        <span
            className="absolute w-auto p-2 m-2 min-w-max right-20 rounded-md shadow-md
    ...
    return (
        <LayoutsProviders>
            <div className="relative ">
                ...
                <div className="mr-28 p-4 pl-8 mt-5 z-10">
